...
class OrderWasCompletedSpec extends ObjectBehavior
{
    ...
    */
    ...
    {
        $this->shouldHaveType(OrderWasCompleted::class);
    ...
    {
        $this::staticEventName()->shouldReturn('OrderWasCompleted');
        $this->eventName()->shouldReturn('OrderWasCompleted');
    }
    ...
    public function it_can_be_restored_from_array()
    {
        ...
        $this::fromArray($array)->shouldHaveType(OrderWasCompleted::class);
